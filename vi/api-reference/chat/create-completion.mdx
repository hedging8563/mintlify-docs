...
<ParamField body="model" type="string" required>
  ID của mô hình để sử dụng. Xem [Models](https://aisonar.dev/models) để biết các tùy chọn có sẵn.
</ParamField>
...
<ParamField body="messages" type="array" required>
  ...
  Khi `content` là một mảng, AI Sonar hỗ trợ các khối đa phương tiện có cấu trúc cho các mô hình tương thích:
  - text: `{ "type": "text", "text": "..." }`
  ...
  Đối với lưu lượng sản xuất đa phương tiện, ưu tiên các URL công khai `https`. AI Sonar sẽ chuyển đổi các khối media này thành dạng yêu cầu cụ thể của nhà cung cấp cần thiết cho mô hình vật lý được chuyển hướng.
</ParamField>
