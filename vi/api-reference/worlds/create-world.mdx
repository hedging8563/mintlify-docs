...
Endpoint này bao gồm world generation và polling. AI Sonar hiện không proxy upload media asset của World Labs, danh sách world, xóa world hoặc công cụ pano độc lập.
