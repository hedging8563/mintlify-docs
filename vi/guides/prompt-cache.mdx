...
Trang này không mô tả semantic cache riêng của AI Sonar. Nó giải thích prompt cache của provider upstream, được phản ánh trong usage và billing khi provider được route trả về cache token.
