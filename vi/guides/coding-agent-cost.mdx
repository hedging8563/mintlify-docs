...
[Cache prompt upstream](/guides/prompt-cache) được tự động hóa qua AI Sonar. Các system prompt dài — mà coding agent luôn bao gồm — được cache ở cấp nhà cung cấp:
