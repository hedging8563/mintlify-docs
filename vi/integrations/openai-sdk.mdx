---
title: "OpenAI SDK"
description: "Sử dụng AI Sonar với các OpenAI SDK chính thức và các client tương thích với OpenAI"
---

## Tổng quan

AI Sonar hoạt động với các OpenAI SDK chính thức bằng cách trỏ client tới `https://api.aisonar.dev/v1`.
...
Chat Completions là đường dẫn tương thích OpenAI mặc định cho AI Sonar:
...
<AccordionGroup>
  <Accordion title="Connection Error">
    - Xác minh rằng base URL chính xác là `https://api.aisonar.dev/v1`
  ...
  <Accordion title="Xác thực thất bại">
    ...
    - Xác minh rằng khóa đang hoạt động trên bảng điều khiển AI Sonar
