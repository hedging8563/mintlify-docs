---
title: "LangChain"
description: "Tích hợp AI Sonar với LangChain bằng chat và embeddings tương thích OpenAI tiêu chuẩn"
---

## Tổng quan

AI Sonar hoạt động tốt với các tích hợp `ChatOpenAI` và `OpenAIEmbeddings` của LangChain khi bạn sử dụng bề mặt chat và embeddings tương thích OpenAI tiêu chuẩn.
...
<AccordionGroup>
  <Accordion title="Truyền `base_url` một cách tường minh">
    Cấu hình AI Sonar đáng tin cậy nhất là truyền `base_url="https://api.aisonar.dev/v1"` trực tiếp vào `ChatOpenAI` và `OpenAIEmbeddings` thay vì phụ thuộc vào các alias biến môi trường cũ hơn.
  </Accordion>
