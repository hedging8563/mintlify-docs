---
title: "Anthropic SDK"
description: "Sử dụng AI Sonar với Anthropic SDK để tương thích với Messages API gốc của Claude"
---

## Tổng quan

AI Sonar hỗ trợ đường dẫn **Messages API** gốc của Anthropic, vì vậy bạn có thể sử dụng trực tiếp Anthropic SDK chính thức cho các model Claude.

<Note>
Đối với Anthropic SDK, hãy sử dụng `https://api.aisonar.dev` làm base URL, không tự thêm `/v1`.
</Note>
...
Trong số các tuyến SDK được tài liệu hóa, đây là một trong những đường dẫn AI Sonar được hỗ trợ mạnh nhất cho các tính năng gốc của Claude.
...
<AccordionGroup>
  <Accordion title="Base URL không đúng">
    - Sử dụng `https://api.aisonar.dev`
    - Không tự thêm `/v1` khi cấu hình Anthropic SDK
  </Accordion>

  <Accordion title="Xác thực thất bại">
    - Kiểm tra rằng API key AI Sonar của bạn bắt đầu bằng `sk-`
  ...
  <Accordion title="Không tìm thấy Model">
    ...
    - Kiểm tra tính khả dụng hiện tại trong danh mục model của AI Sonar
  </Accordion>
</AccordionGroup>