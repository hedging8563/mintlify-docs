...
[Upstream prompt caching](/guides/prompt-cache) is automatic through AI Sonar. Long system prompts — which coding agents always include — get cached at the provider level:
