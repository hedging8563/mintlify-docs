...
AI Sonar does not add a separate semantic cache in this guide. This page explains upstream provider prompt caching, which appears in usage and billing when the routed provider reports cache tokens.
