...
<ResponseField name="tokenlab" type="object">
  AI Sonar 전용 공개 메타데이터입니다. 상세 경로는 `category`, `pricing_unit`, `capability_flags`, `supported_operations`, `pricing_provenance`, `request_format_summary`, 전체 `request_format_details`, 그리고 비채팅 추천 스냅샷용 scene 수준의 `agent_preferences` 를 포함할 수 있습니다.
</ResponseField>
