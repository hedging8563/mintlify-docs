...
<Note>
  표시된 가격은 할인된 플랫폼 가격입니다. 실제 가격은 변동될 수 있습니다. 현재 요율은 [pricing page](https://aisonar.dev/ko/pricing)에서 확인하세요.
</Note>
...
터미널 상태가 확인된 뒤에도 dashboard에 정산 또는 환불이 반영되지 않으면 support@aisonar.dev로 문의하세요.
...
결제 관련 문의는 support@aisonar.dev로 연락해 주세요.
