---
title: "OpenAI SDK"
description: "공식 OpenAI SDK 및 OpenAI 호환 클라이언트를 사용하여 AI Sonar 사용"
---

## 개요

AI Sonar는 클라이언트의 base URL을 `https://api.aisonar.dev/v1`로 지정하여 공식 OpenAI SDK와 함께 작동합니다.
...
Chat Completions는 AI Sonar의 기본 OpenAI 호환 경로입니다:
...
<AccordionGroup>
  <Accordion title="연결 오류">
    - base URL이 정확히 `https://api.aisonar.dev/v1`인지 확인하세요
