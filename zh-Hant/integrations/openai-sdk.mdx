---
title: "OpenAI SDK"
description: "在官方 OpenAI SDK 及相容客戶端中使用 AI Sonar"
---

## 概覽

AI Sonar 可與官方 OpenAI SDK 一起使用，方法是將客戶端指向 `https://api.aisonar.dev/v1`。
...
Chat Completions 是 AI Sonar 的預設 OpenAI 相容路徑：
...
<AccordionGroup>
  <Accordion title="連線錯誤">
    - 驗證 base URL 是否完全為 `https://api.aisonar.dev/v1`
