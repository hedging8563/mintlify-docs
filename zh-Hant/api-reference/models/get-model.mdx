...
<ResponseField name="tokenlab" type="object">
  AI Sonar 專屬的公開中繼資料。詳情路由可包含 `category`、`pricing_unit`、`capability_flags`、`supported_operations`、`pricing_provenance`、`request_format_summary`、完整的 `request_format_details`，以及非聊天推薦快照的場景級 `agent_preferences`。
</ResponseField>
