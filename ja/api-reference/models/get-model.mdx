...
<ResponseField name="tokenlab" type="object">
  AI Sonar 固有の公開メタデータです。詳細ルートでは、`category`、`pricing_unit`、`capability_flags`、`supported_operations`、`pricing_provenance`、`request_format_summary`、完全な `request_format_details`、そして非チャット推奨スナップショット用のシーン別 `agent_preferences` を含めることができます。
</ResponseField>
