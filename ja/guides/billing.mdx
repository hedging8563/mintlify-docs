...
<Note>
  表示されている価格は割引後のプラットフォーム価格です。実際の価格は変動する場合があります。最新の料金については [pricing page](https://aisonar.dev/ja/pricing) を確認してください。
</Note>
...
終端状態が確認できるにもかかわらず dashboard に決済または返金が反映されない場合は、support@aisonar.dev までお問い合わせください。
...
請求に関するお問い合わせは support@aisonar.dev までご連絡ください。
