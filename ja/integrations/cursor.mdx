---
title: "Cursor"
description: "Cursor AI コードエディタで AI Sonar を使用する"
---
...
[Cursor](https://cursor.sh) は bring-your-own-key (BYOK) 型のプロバイダーをサポートしていますが、カスタム API キーが機能するのは標準的なチャットモデルのみです。ここでは AI Sonar を、あらゆる Cursor のモデル機能を完全に置き換えるものとしてではなく、チャット型のエディタ作業向け OpenAI 互換エンドポイントとして使用してください。
...
設定後は、AI Sonar を通じて提供される標準的なチャットモデルを優先して使用してください:
...
これらの機能は、AI Sonar エンドポイントへ確実には切り替わりません:
...
<AccordionGroup>
  ...
  <Accordion title="AI Sonar を有効にした後、別のプロバイダーが動作しなくなった">
...
<CardGroup cols={2}>
  ...
  <Card title="残高を確認する" icon="wallet">
    AI Sonar ダッシュボードで使用状況を監視してください。
  </Card>
</CardGroup>
