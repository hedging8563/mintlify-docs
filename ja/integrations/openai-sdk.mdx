---
title: "OpenAI SDK"
description: "公式のOpenAI SDKおよびOpenAI互換クライアントでAI Sonarを使用する"
---

## 概要

AI Sonarはクライアントのbase URLを`https://api.aisonar.dev/v1`にポイントすることで公式のOpenAI SDKと連携します。
...
Chat CompletionsはAI SonarのデフォルトのOpenAI互換パスです:
...
<AccordionGroup>
  <Accordion title="接続エラー">
    - ベースURLが正確に `https://api.aisonar.dev/v1` になっていることを確認してください
