---
title: "Quickstart"
description: "Get started with AI Sonar API in 2 minutes"
---
...
<Steps>
  <Step title="Create an account">
    Sign up at [aisonar.dev](https://aisonar.dev) using your email, Gmail, or GitHub account.
  </Step>
...
AI Sonar supports hundreds of models. Change only the `model` field:
