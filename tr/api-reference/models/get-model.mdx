...
<ResponseField name="tokenlab" type="object">
  AI Sonar'ya özgü herkese açık metadata. Detay route'u `category`, `pricing_unit`, `capability_flags`, `supported_operations`, `pricing_provenance`, `request_format_summary`, tam `request_format_details` ve chat dışı öneri snapshot'ları için sahne düzeyinde `agent_preferences` içerebilir.
</ResponseField>
