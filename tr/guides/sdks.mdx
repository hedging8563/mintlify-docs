...
description: "AI Sonar entegrasyonları için önerilen SDK'ler ve kütüphaneler"
---

## Genel Bakış

AI Sonar'yı, SDK'yı ihtiyacınız olan davranışla eşleştirerek entegre etmesi en kolay olanıdır:
...
| Mevcut OpenAI uyumlu istemci | AI Sonar üzerindeki OpenAI SDK `/v1` |
...
<AccordionGroup>
  ...
  <Accordion title="Geçiş için OpenAI uyumlu `/v1` kullan">
    OpenAI ile uyumlu SDK'lar, mevcut OpenAI tarzı istemciler, taşınabilir sohbet ve embedding'ler için en iyi yoldur. Onları tek AI Sonar API yüzeyi değil, bir uyumluluk yolu olarak değerlendirin.
  </Accordion>

  <Accordion title="Base URL'leri açık tutun">
    Daha eski ortam değişkeni takma adlarına güvenmek yerine AI Sonar base URL'lerini doğrudan istemci yapılandırmanızda iletin.
  </Accordion>
</AccordionGroup>
