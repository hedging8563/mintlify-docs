...
description: "Commencez avec l'API AI Sonar en 2 minutes"
---
...
<Steps>
  <Step title="Créer un compte">
    Inscrivez-vous sur [aisonar.dev](https://aisonar.dev) avec votre e-mail, Gmail ou compte GitHub.
  </Step>
...
AI Sonar prend en charge plus de 300 modèles. Changez uniquement le champ `model` :
