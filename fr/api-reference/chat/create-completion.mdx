...
<ParamField body="model" type="string" required>
  ID du modèle à utiliser. Voir [Modèles](https://aisonar.dev/models) pour les options disponibles.
</ParamField>
...
<ParamField body="messages" type="array" required>
  ...
  Lorsque `content` est un tableau, AI Sonar prend en charge des blocs multimodaux structurés pour les modèles compatibles :
  - text: `{ "type": "text", "text": "..." }`
  - image: `{ "type": "image_url", "image_url": { "url": "https://..." } }`
  - vidéo: `{ "type": "video_url", "video_url": { "url": "https://..." } }`
  - audio: `{ "type": "audio_url", "audio_url": { "url": "https://..." } }`

  Pour le trafic multimodal en production, privilégiez des URLs publiques en `https`. AI Sonar traduira ces blocs médias dans la forme de requête spécifique au fournisseur requise par le modèle physique routé.
</ParamField>
