...
Cette page ne décrit pas un cache sémantique séparé de AI Sonar. Elle explique le prompt cache des fournisseurs upstream, visible dans l’usage et la facturation lorsque le fournisseur routé renvoie des tokens de cache.
