...
<ParamField body="model" type="string" required>
  معرف النموذج المستخدم. راجع [Models](https://aisonar.dev/models) للاطلاع على الخيارات المتاحة.
</ParamField>
...
<ParamField body="messages" type="array" required>
  ...
  عندما تكون `content` مصفوفة، يدعم AI Sonar كتلًا مُهيكلة متعددة الوسائط للنماذج المتوافقة:
  - text: `{ "type": "text", "text": "..." }`
  - image: `{ "type": "image_url", "image_url": { "url": "https://..." } }`
  - video: `{ "type": "video_url", "video_url": { "url": "https://..." } }`
  - audio: `{ "type": "audio_url", "audio_url": { "url": "https://..." } }`

  لحركة المرور متعددة الوسائط في الإنتاج، يُفضّل استخدام روابط `https` عامة. سيقوم AI Sonar بترجمة هذه الكتل الوسائطية إلى شكل الطلب الخاص بمزود الخدمة المطلوب للنموذج الفيزيائي الموجه.
</ParamField>
