---
title: "LangChain"
description: "دمج AI Sonar مع LangChain باستخدام واجهات chat و embeddings القياسية المتوافقة مع OpenAI"
---

## نظرة عامة

يعمل AI Sonar بشكل جيد مع تكاملات `ChatOpenAI` و `OpenAIEmbeddings` في LangChain عندما تلتزم بواجهة chat و embeddings القياسية المتوافقة مع OpenAI.
...
<AccordionGroup>
  <Accordion title="مرّر `base_url` بشكل صريح">
    الإعداد الأكثر موثوقية لـ AI Sonar هو تمرير `base_url="https://api.aisonar.dev/v1"` مباشرةً إلى `ChatOpenAI` و `OpenAIEmbeddings` بدلًا من الاعتماد على الأسماء المستعارة الأقدم لمتغيرات البيئة.
  </Accordion>
