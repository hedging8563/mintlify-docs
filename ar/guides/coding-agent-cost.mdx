...
[Prompt caching من المزود](/ar/guides/prompt-cache) يعمل تلقائيًا عبر AI Sonar. System prompts الطويلة — التي تتضمنها Coding Agents دائمًا — تُخزَّن على مستوى المزود:
...
| AI Sonar (توجيه ذكي) | ~$10–18 | ~$1,600–2,900 |
| AI Sonar + Prompt Cache | ~$4–8 | ~$640–1,280 |
| AI Sonar + كلا التخزينين | ~$2–5 | ~$320–800 |
...
كل أداة تحتاج بضعة أسطر فقط للاتصال عبر AI Sonar:
