---
title: "OpenAI SDK"
description: "Gunakan AI Sonar dengan SDK resmi OpenAI dan klien yang kompatibel dengan OpenAI"
---

## Ringkasan

AI Sonar bekerja dengan SDK resmi OpenAI dengan mengarahkan klien ke `https://api.aisonar.dev/v1`.
...
Chat Completions adalah jalur default yang kompatibel dengan OpenAI untuk AI Sonar:
...
<AccordionGroup>
  <Accordion title="Kesalahan Koneksi">
    - Pastikan base URL persis `https://api.aisonar.dev/v1`
  ...
  <Accordion title="Autentikasi Gagal">
    ...
    - Verifikasi bahwa kunci aktif di dashboard AI Sonar
