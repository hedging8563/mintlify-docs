---
title: "LangChain"
description: "Integrasikan AI Sonar dengan LangChain menggunakan chat dan embeddings standar yang kompatibel dengan OpenAI"
---

## Gambaran Umum

AI Sonar bekerja dengan baik dengan integrasi `ChatOpenAI` dan `OpenAIEmbeddings` milik LangChain ketika Anda tetap menggunakan surface chat dan embeddings standar yang kompatibel dengan OpenAI.
...
texts = [
    ...
    "AI Sonar mendukung integrasi yang kompatibel dengan OpenAI."
]
...
<AccordionGroup>
  <Accordion title="Teruskan base_url secara eksplisit">
    Setup AI Sonar yang paling andal adalah meneruskan `base_url="https://api.aisonar.dev/v1"` secara langsung ke `ChatOpenAI` dan `OpenAIEmbeddings` alih-alih bergantung pada alias environment variable yang lebih lama.
  </Accordion>
