...
Halaman ini tidak menjelaskan semantic cache terpisah dari AI Sonar. Halaman ini menjelaskan prompt cache provider upstream, yang muncul di penggunaan dan penagihan saat provider yang dirutekan melaporkan cache token.
