...
[Prompt caching upstream](/id/guides/prompt-cache) berjalan otomatis melalui AI Sonar. System prompt panjang — yang selalu disertakan coding agents — di-cache di level provider:
