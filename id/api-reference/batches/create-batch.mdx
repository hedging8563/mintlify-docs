...
Endpoint ini adalah bagian dari API Batch yang kompatibel dengan OpenAI dari AI Sonar. Pekerjaan batch menggunakan file JSONL yang diunggah, berjalan secara asinkron, dan dapat mengembalikan file output/error di kemudian hari.
