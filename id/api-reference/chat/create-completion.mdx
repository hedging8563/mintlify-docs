...
<ParamField body="messages" type="array" required>
  ...
  Ketika `content` adalah array, AI Sonar mendukung blok multimodal terstruktur untuk model yang kompatibel:
  - text: `{ "type": "text", "text": "..." }`
  ...
  Untuk lalu lintas produksi multimodal, utamakan URL publik `https`. AI Sonar akan menerjemahkan blok media ini ke bentuk permintaan spesifik provider yang diperlukan oleh model fisik yang diarahkan.
</ParamField>
