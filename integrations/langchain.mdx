---
title: "LangChain"
description: "Integrate AI Sonar with LangChain using standard OpenAI-compatible chat and embeddings"
---

## Overview

AI Sonar works well with LangChain's `ChatOpenAI` and `OpenAIEmbeddings` integrations when you stay on the standard OpenAI-compatible chat and embeddings surface.
...
<AccordionGroup>
  <Accordion title="Pass base_url explicitly">
    The most reliable AI Sonar setup is to pass `base_url="https://api.aisonar.dev/v1"` directly to `ChatOpenAI` and `OpenAIEmbeddings` instead of depending on older environment-variable aliases.
  </Accordion>
