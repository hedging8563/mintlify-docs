---
title: "OpenAI SDK"
description: "Use AI Sonar with official OpenAI SDKs and OpenAI-compatible clients"
---

## Overview

AI Sonar works with the official OpenAI SDKs by pointing the client to `https://api.aisonar.dev/v1`.
...
Chat Completions is the default OpenAI-compatible path for AI Sonar:
...
<AccordionGroup>
  ...
  <Accordion title="Authentication Failed">
    ...
    - Verify the key is active in AI Sonar dashboard
