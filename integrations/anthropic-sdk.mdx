---
title: "Anthropic SDK"
description: "Use AI Sonar with the Anthropic SDK for Claude-native Messages API compatibility"
---

## Overview

AI Sonar supports the native Anthropic **Messages API** path, so you can use the official Anthropic SDK directly for Claude models.

Among the documented SDK routes, this is one of the strongest-supported AI Sonar paths for Claude-native features.
