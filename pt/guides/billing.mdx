...
<Note>
  Os preços exibidos são preços com desconto da plataforma. Os preços reais podem variar. Verifique a [página de preços](https://aisonar.dev/pt/pricing) para as taxas atuais.
</Note>
...
Se o dashboard não refletir a liquidação ou o reembolso depois que o estado terminal estiver visível, entre em contato com support@aisonar.dev.
...
Entre em contato com support@aisonar.dev para consultas de faturamento.
