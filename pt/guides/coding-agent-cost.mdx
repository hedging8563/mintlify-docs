...
O [cache de prompt upstream](/guides/prompt-cache) é automático pelo AI Sonar. Prompts de sistema longos — que agentes de código sempre incluem — são armazenados em cache no nível do provedor:
