...
description: "Use o AI Sonar com o SDK da Anthropic para compatibilidade nativa com a Messages API do Claude"
---

## Visão geral

O AI Sonar oferece suporte ao caminho nativo da **Messages API** da Anthropic, para que você possa usar diretamente o SDK oficial da Anthropic com modelos Claude.

<Note>
Para o SDK da Anthropic, use `https://api.aisonar.dev` como base URL, sem adicionar `/v1` manualmente.
</Note>
...
Entre as rotas de SDK documentadas, este é um dos caminhos do AI Sonar com melhor suporte para recursos nativos do Claude.
...
<AccordionGroup>
  ...
  <Accordion title="Falha na autenticação">
    - Verifique se sua chave de API do AI Sonar começa com `sk-`
    - Confirme se a chave está ativa no dashboard do AI Sonar
  ...
  <Accordion title="Modelo não encontrado">
    ...
    - Confira a disponibilidade atual no catálogo de modelos do AI Sonar
  </Accordion>
</AccordionGroup>