...
<ResponseField name="tokenlab" type="object">
  Öffentliche AI Sonar-Metadaten. Die Detailroute kann `category`, `pricing_unit`, `capability_flags`, `supported_operations`, `pricing_provenance`, `request_format_summary`, das vollständige `request_format_details` sowie szenenbezogene `agent_preferences` für Nicht-Chat-Empfehlungssnapshots enthalten.
</ResponseField>
