...
<ParamField body="messages" type="array" required>
  ...
  Wenn `content` ein Array ist, unterstützt AI Sonar strukturierte multimodale Blöcke für kompatible Modelle:
  - text: `{ "type": "text", "text": "..." }`
  - Bild: `{ "type": "image_url", "image_url": { "url": "https://..." } }`
  - audio: `{ "type": "audio_url", "audio_url": { "url": "https://..." } }`
  - video: `{ "type": "video_url", "video_url": { "url": "https://..." } }`

  Für multimodalen Produktionstraffic bevorzugen Sie öffentliche `https`-URLs. AI Sonar übersetzt diese Medienblöcke in die anbieter-spezifische Anforderungsform, die vom gerouteten physischen Modell benötigt wird.
</ParamField>
