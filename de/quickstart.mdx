---
title: "Schnellstart"
description: "Beginnen Sie in 2 Minuten mit der AI Sonar API"
---
...
<Steps>
  <Step title="Konto erstellen">
    Registrieren Sie sich unter [aisonar.dev](https://aisonar.dev) mit Ihrer E-Mail-, Gmail- oder GitHub-Adresse.
  </Step>
...
AI Sonar unterstützt über 300 Modelle. Ändern Sie nur das Feld `model`:
